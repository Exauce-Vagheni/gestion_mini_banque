...
<body>
	...
	<form method="post" action="">
		<div class="container">
		<h3 class="mt-3">Effectuer un dépôt dans un compte épargne</h3>
		<?php include("save_epargne.php"); ?>
	<div class="mb-3">
  ...
  <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="montant" name="epargne">
</div>
